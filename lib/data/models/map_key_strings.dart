...
const String ADDITIONAL_REMARKS = 'additionalRemarks';
const String NUM_APPLIED = 'numApplied';
const String SUBJECT = 'subject';
const String TUTEE_NAME = 'tuteeName';
const String RATEMAX = 'rateMax';
const String RATEMIN = 'rateMin';
const String LOCATION = 'location';
const String NUM_LIKED = 'numLiked';
...
const String TUTOR_PROFILE = 'tutorProfile';
...
const String NUM_REQUEST = 'numRequest';
const String NUM_CLICKS = 'numClicks';
